...
class ZNodeName implements Comparable<ZNodeName> {
	 ...
	 * @return the difference between their sequence numbers: a positive value if
	 *         this znode has a larger sequence number, 0 if they have the same
	 *         sequence number or a negative number if this znode has a lower
	 *         sequence number
	 */
